...
- Final environment verification: `$source = git rev-parse HEAD; .\.venv\Scripts\python.exe scripts\verify_final_environment.py --source-commit $source --output evidence\final-environment.json`
