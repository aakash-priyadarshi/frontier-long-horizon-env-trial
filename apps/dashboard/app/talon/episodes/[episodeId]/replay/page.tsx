...
export default function TalonEpisodeReplayPage() {
  ...
  return <>
    ...
    {error ? <ErrorState message={error} retry={() => void load()} /> : !replay || !step ? <LoadingState rows={6} label="Loading immutable replay" /> : <>
      ...
      <section className="surface-section"><h2>Replay integrity and access boundary</h2><dl className="detail-grid"><div><dt>Replay digest</dt><dd><code>{replay.replay_digest}</code></dd></div><div><dt>Checkpoint</dt><dd><code>{replay.checkpoint_digest}</code></dd></div><div><dt>View</dt><dd>Policy-visible public record</dd></div><div><dt>Chain of thought</dt><dd>Not collected or retained</dd></div></dl></section>
    </>}
  </>;
}
